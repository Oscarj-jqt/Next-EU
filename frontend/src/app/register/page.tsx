      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form className="flex flex-col">
          ...
          <input 
            ...
            className="mb-4 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
          ...
          <input 
            type="password" 
            placeholder="••••••••"
            className="mb-6 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
