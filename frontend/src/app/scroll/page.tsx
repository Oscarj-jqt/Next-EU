...
const videosByCountry: Record<string, { url: string; description: string }[]> = {
    France: [
      ...
      Cyprus: [
        ...
        { url: "https://res.cloudinary.com/dyhcikuhl/video/upload/v1742462133/a3oiebs0xt2ct7w8qdd7.mp4", description: "Vidéo Chypre 2" },
        { url: "https://res.cloudinary.com/dyhcikuhl/video/upload/v1742462133/xyimkjyqb6hbw2ajapxj.mp4", description: "Vidéo Chypre 3" },
        { url: "https://res.cloudinary.com/dyhcikuhl/video/upload/v1742460846/qdlo6xpupg4qmhiascrb.mp4", description: "Vidéo Chypre 4" },
        { url: "https://res.cloudinary.com/dyhcikuhl/video/upload/v1742460842/lc5nxx7rhowtjoto1vst.mp4", description: "Vidéo Chypre 5" },
      ]
    };
